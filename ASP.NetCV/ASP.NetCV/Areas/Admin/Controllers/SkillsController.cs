...
namespace ASP.NetCV.Areas.Admin.Controllers
{
    ...
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("skilsName,skillDesc,Id,CreatByUserId,CreatDate,DeletedByUserID,DeletedDate")] Skills skills)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("skilsName,skillDesc,Id,CreatByUserId,CreatDate,DeletedByUserID,DeletedDate")] Skills skills)
        {
            if (id != skills.Id)
            {
                return NotFound();
